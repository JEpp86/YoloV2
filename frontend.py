...
class YOLO(object):
    def __init__(self, backend,
        ...
        if backend == 'Inception3':
            ...
            feature = MobileNetFeature(self.input_size)
            self.grid_h, self.grid_w = feature.get_shape()
            self.feature_extractor = feature#MobileNetFeature(self.input_size)
